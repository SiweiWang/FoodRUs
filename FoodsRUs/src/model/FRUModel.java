...
public class FRUModel {
    ...
    public void exportPO(String filename, int id, ClientBean customer, ShoppingCartHelper shoppingCart) throws JAXBException, IOException
    {
		...
		OrderWrapper ow = new OrderWrapper(id, today, customer, shoppingCart.getItems(), shoppingCart.getTotal(), shoppingCart.getShipping(), shoppingCart.getHST(), shoppingCart.getGrandTotal());
